...
<svelte:head>
	<title>Footape - Privacy Policy</title>
	<meta content="Footape - Privacy Policy" property="og:title">
	<meta content="Footape - Privacy Policy" property="twitter:title">
</svelte:head>

<Header isConnected={!!$page.data.session?.user} />
<div class="bg-base-300 text-center py-24">
	<h1>Privacy Policy</h1>
</div>
<div class="max-w-4xl mx-auto py-28">
	<p>Last updated: Mar 22, 2023</p>
	<br />
	<p>
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Footape.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Footape, accessible from
				<a href="https://footape.com" rel="external nofollow noopener" target="_blank"
					>https://footape.com</a
				>
			</p>
		</li>
	...
	<ul>
		<li>By email: contact@footape.com</li>
	</ul>
</div>
<Footer />
...
<style>
	...
	h3 {
		@apply text-2xl font-bold my-10;
	}
	...
	ul {
		@apply list-disc space-y-4 py-8 pl-12;
	}
</style>
